...
const Busqueda = () => {
    const { buscador,handleBuscador, proyectos } = useProyectos(); /*Extraer los proyectos para filtrarlos */
    const [ busqueda, setBusqueda] = useState('');

    const proyectosFiltrados = busqueda === '' ? [] : proyectos.filter(
        proyecto => proyecto.nombre.toLowerCase().includes(busqueda.toLocaleLowerCase())
        );
