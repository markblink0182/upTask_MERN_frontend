...
const Proyecto = () => {
  ...
  return (
        <>
            ...
            {/* Mostrar las tareas */}
            {/* Inicia- Mostrar colaboradores */}
            {admin && (
            <>
                <div className='flex items-center justify-between'>
                    <p className="font-bold text-xl mt-8">Colaboradores</p>
                    <Link
                    to= {`/proyectos/nuevo-colaborador/${proyecto._id}`}
                    className='text-gray-700 uppercase font-bold hover:text-black'
                    >
                        Añadir
                    </Link>   
                </div>
